      ...
      <div className="min-h-[500px] p-14 px-10 relative border border-border mx-auto max-w-2xl lg:max-w-5xl mb-10 rounded-xl">
        <div className="z-40 relative">
          ...
          <div className="text-3xl font-semibold mt-1">
            Reach me out{" "}
            <a
              className="bg-gradient-to-r cursor-pointer inline from-green-400 via-green-600 to-green-800 text-transparent bg-clip-text bg-300% animate-gradient"
              href="mailto:sergeyiksanov25@gmail.com"
              target="_blank"
            >
              via Email
            </a>{" "}
          ...
          <div className="mt-36 flex justify-between flex-col md:flex-row">
            <div>
              <div className="text-lg font-semibold">Sergey Iksanov</div>
